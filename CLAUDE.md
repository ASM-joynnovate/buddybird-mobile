...
- `hotfix/*` → `main`: 긴급 패치, staging 우회 가능. `yarn release:bump patch` 커밋 포함 의무. merge 후 `main → staging` back-merge **(핫픽스 한정 의무)** (단일 semver + buildNumber 분리 패턴, `docs/BUILD-AND-RELEASE.md` §12.2)
